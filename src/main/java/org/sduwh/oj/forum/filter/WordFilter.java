...
import org.sduwh.oj.forum.common.WordNode;
import org.sduwh.oj.forum.util.SDBCConvert;
...
public class WordFilter {
	...
	private static void init() {
		// 获取敏感词
		addSensitiveWord(readWordFromFile("./static/wd.txt"));
		addStopWord(readWordFromFile("./static/stopwd.txt"));
	}
